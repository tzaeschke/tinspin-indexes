...
public class TestStats implements Serializable, Cloneable {
  ...
  /**
   * How often kNN queries are repeated. This is reduced automatically with increasing
   * dimensionality.
   */
  ...
  public String toString() {
    ...
    //			ret += statTq1 + D + statTq1E + D + statTq2 + D + statTq2E + D + statTqp1 + D + statTqp1E +
    // D + statTqp2 + D + statTqp2E + D;
  ...
  public static TestStats aggregate(List<TestStats> stats) {
    ...
    avg.statTqk1_2E /= cnt;
    avg.statTqk10_1 /= cnt;
    avg.statTqk10_1E /= cnt;
    avg.statTqk10_2 /= cnt;
    avg.statTqk10_2E /= cnt;
    avg.statTu1 /= cnt;
    avg.statTu1E /= cnt;
    avg.statTu2 /= cnt;
    avg.statTu2E /= cnt;
    ...
    // avg.statNBits /= cnt;
    // avg.statNDims /= cnt;
    // avg.statNEntries /= cnt;
    avg.statNpostlen /= cnt;
    avg.statNNodeAHC /= cnt;
    avg.statNNodeNT /= cnt;
    avg.statNNodeInternalNT /= cnt;
    avg.statNq1 /= cnt;
    avg.statNq2 /= cnt;
    avg.statNqp1 /= cnt;
    avg.statNqp2 /= cnt;
    ...
    avg.statGcDiffL /= cnt;
    avg.statGcTimeL /= cnt;
    avg.statGcDiffWq /= cnt;
    avg.statGcTimeWq /= cnt;
    avg.statGcDiffPq /= cnt;
    avg.statGcTimePq /= cnt;
    avg.statGcDiffUp /= cnt;
    avg.statGcTimeUp /= cnt;
    avg.statGcDiffUl /= cnt;
    avg.statGcTimeUl /= cnt;
