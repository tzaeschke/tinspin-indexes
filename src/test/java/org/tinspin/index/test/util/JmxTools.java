...
public class JmxTools {
  ...
  public static void startUp() {
    ...
    for (GarbageCollectorMXBean b : ManagementFactory.getGarbageCollectorMXBeans()) {
      //			System.out.println("GC-Bean: " + b.getName() +  "   c=" + b.getCollectionCount() + "  t="
      // + b.getCollectionTime());
      try {
  ...
  private static class MemInfo {
    ...
    public String toString() {
      return "threads=" + gcThreadCount + "  id=" + id + "  dur=" + duration + "  diff=" + diff;
    }
  }
  ...
  private static void processNotification(ObjectName name) {
    ...
    MemInfo mi =
        new MemInfo((int) mix[0], (long) mix[1], (long) mix[2]); // , (Long)mix[3], (Long)mix[4]);
  ...
  //				System.out.println("MP-Bean: " + b.getName() + "  " + b.getType() + "  peak=" +
  // b.getPeakUsage());
