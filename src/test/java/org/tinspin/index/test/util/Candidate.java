...
public abstract class Candidate {
  ...
  /** This method is invoked at the end of the test run to allow freeing of allocated resources */
  public abstract void release();

  public abstract void load(double[] data, int idxDim);

  /**
   * This method is called before the actual point query, providing the underlying tree with the
  ...
  /**
   * Called when the tree should execute the point queries defined by the arguments.
   *
  ...
  /**
   * Called when the tree should execute the k-nearest-neighbor queries defined by the arguments.
   *
  ...
  /**
   * Called when the tree should delete all the points it contains. The deletion should happen in
   * N/2 steps where the first and last element (in order of insertion) that are still in the tree
   * should be deleted
   *
