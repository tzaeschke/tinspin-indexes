...
/**
 * This version of CritBit uses Copy-On-Write to create new versions of the tree following each
 * write operation.
 *
 * <p>A concurrency enabled version of the CritBit64 tree. The implementation uses copy-on-write
 * concurrency, therefore locking occurs only during updates, read-access is never locked.
 *
 * <p>Currently write/update access is limited to one thread at a time. Read access guarantees full
 * snapshot consistency for all read access including iterators.
 *
 * <p>Version 1.3.4 - CB64COW is now a sub-class of CB64
 *
 * <p>Version 1.3.3 - Fixed 64COW iterators returning empty Entry for queries that shouldn't return
 * anything.
 *
 ...
 *
 * <p>Version 1.0: initial implementation
 *
 * @author bvancea
 * @param <V> value type
 */
