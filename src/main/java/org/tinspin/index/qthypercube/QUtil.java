...
class QUtil {
  ...
  /**
   * The tests for inclusion with UPPER BOUNDARY EXCLUSIVE! I.e. it firs only if point is SMALLER
   * than (center + radius).
   */
  ...
  public static boolean isRectEnclosed(
      double[] minEnclosed, double[] maxEnclosed, double[] minOuter, double[] maxOuter) {
  ...
  /**
   * The tests for inclusion with UPPER BOUNDARY EXCLUSIVE! I.e. it firs only if maxEnclosed is
   * SMALLER than (center + radius).
   */
  public static boolean fitsIntoNode(
      double[] minEnclosed, double[] maxEnclosed, double[] centerNode, double radiusNode) {
  ...
  public static boolean isNodeEnclosed(
      double[] centerEnclosed, double radiusEnclosed, double[] centerOuter, double radiusOuter) {
  ...
  static double distToRectNode(
      double[] point, double[] nodeCenter, double nodeRadius, PointDistance distFn) {
