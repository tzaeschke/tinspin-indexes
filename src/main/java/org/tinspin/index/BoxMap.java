...
public interface BoxMap<T> extends Index {
  ...
  interface Factory {
    /**
     * Create an array backed BoxMap. This is only for testing and rather inefficient for large data
     * sets.
     *
     ...
     * @return New Quadtree
     */
    static <T> BoxMap<T> createQuadtree(
     ...
     */
    @Deprecated
    static <T> BoxMap<T> createQuadtreeHC(
