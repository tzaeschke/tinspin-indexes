 ...
 * kNN search.
 *
 * <p>Implementation after Hjaltason and Samet. G. R. Hjaltason and H. Samet., "Distance browsing in
 * spatial databases.", ACM TODS 24(2):265--318. 1999
 *
...
public class CoverTreeQueryKnn<T> implements PointIteratorKnn<T> {
  ...
  private final PriorityQueue<PointEntryKnn<Object>> queue =
      new PriorityQueue<>(Index.PE_COMP_DEFAULT);
