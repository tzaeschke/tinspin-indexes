...
/**
 * A common interface for spatial indexes (multimaps) that use points as keys. This interface
 * requires indexes to be multimaps which mean a given keys can exist multiple times and is not
 * overwritten when a new entry with the same key is added.
 *
...
public interface PointMultimap<T> extends Index {
  ...
  interface Factory {
    /**
     * Create an array backed PointMultiMap. This is only for testing and rather inefficient for
     * large data sets.
     *
     ...
     */
    @Deprecated
    static <T> PointMultimap<T> createQuadtree(
     ...
     */
    @Deprecated
    static <T> PointMultimap<T> createQuadtreeHC(
        int dims, int maxNodeCapacity, double[] center, double radius) {
     ...
     */
    @Deprecated
    static <T> PointMultimap<T> createQuadtreeHC2(
        int dims, int maxNodeCapacity, double[] center, double radius) {
